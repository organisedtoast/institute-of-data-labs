// Create a unit test for divideNumbers function in calculatorController.js using Jest and Supertest
// to test the /calculator/divide route.
...
// import Exp[ress application instance from app.js so that we can make requests to it in our tests
...
test('GET /calculator/divide => quotient of numbers', () => {
    ...
    // make a GET request to the /calculator/divide endpoint with the two random numbers as query parameters
    ...
    .then((response) => {
        ...
        // expect the response body to be an object with a result property that equals the quotient of the two random numbers
        expect(response.body).toEqual({

            // the result property should equal the quotient of number1 and number2
