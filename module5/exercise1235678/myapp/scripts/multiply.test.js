// Create a unit test for multiplyNumbers function in calculatorController.js using Jest and Supertest
// to test the /calculator/multiply route.
...
test('GET /calculator/multiply => product of numbers', () => {
    ...
    // make a GET request to the /calculator/multiply endpoint with the two random numbers as query parameters
    ...
    .then((response) => {
        ...
        // expect the response body to be an object with a result property that equals the product of the two random numbers
        expect(response.body).toEqual({
            
            // the result property should equal the product of number1 and number2
